...
## Scaffolding Process (Project Set up)

Open your terminal and move to your parent project directory: `cd prodev-mobile-setup`

Initialize a new Expo project using the latest Expo Router template: `npx create-expo-app@latest`
Enter the name of your project.

After the process is complete, move to your project directory: `cd my-mobile-app-project-name`.
